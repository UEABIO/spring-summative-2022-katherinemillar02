...
```{r, echo=FALSE} 
knitr::kable(head(model1table[, 1:4]), "model1table") f0lifespanls3table!!!!
```
...
```{r, echo=FALSE} 
knitr::kable(head(model2table[, 1:4]), "model2table") f0lifespanls1table!!!!
```
...
```{r, echo=FALSE}
knitr::kable(head(model3table[, 1:4]), "model3table") f0reproductionls1table !!!!
```
...
```{r, echo=FALSE}
knitr::kable(head(model4table[, 1:4]), "model4table") f1longevityls2table!!!!
```
