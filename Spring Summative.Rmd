...
The hypothesis that stressful conditions in the f0 generation have an affect on their on longevity was tested. Previous research has indicated that there have been previous studies into the relation of stressful conditions and longevity of the nematode worm. Although, a connection between the two has been found, the data for the exact reasonings is skewed (Zhou et al, 2011). A factor to be considered, with nematodes which are able to withstand an true affect of aging from stress, are known to have resistance to increased stress resistance. 
...
It was found that there was a significant difference for the treatment dark treatment and longevity against light treatment and longevity, (F, 4.09) (P=5.21^-5).
For light treatment, (F, -15.4) (P=4.97^-42). it was then tested to see if the rnai:treatment interaction effect was relevant, the value was = 0.006, so the interaction effect was kept. rnai empty vector and dark treatment to rnai raga-1 and light treatment (F-2.75) (P=6.23^-3). 
