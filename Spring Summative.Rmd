...
# Analysis  
 Statistical analyses were performed in R 4.1.3. Generalized linear models (GLM) assuming a Poisson/quasi-Poisson variable and a log-link function were used. As well as general linear models with log or square rooted transformations.  
Packages used 
